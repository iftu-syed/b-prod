...
#     # Function to get event details based on date
#     def get_event_for_date(date_str):
#         for event in events:
...
#             for idx, assessment in enumerate(assessments):
#                 date = assessment["timestamp"]
#                 date_str = date if isinstance(date, str) else date.strftime("%Y-%m-%d")  # Ensure date_str is a string
#                 months_since_baseline = idx + 1  # Use index to represent months_since_baseline count
#                 score = assessment["scoreDetails"]["T-Score"]
#                 trace_name = assessment["scoreDetails"]["Name"]  # Capture the trace_name
#                 title = assessment["scoreDetails"]["Name"]

#                 # Get event details for the date
#                 event_date, event_name = get_event_for_date(date_str)

#                 # Debugging statements
#                 print(f"Processing assessment: date={date_str}, score={score}, trace_name={trace_name}")
#                 print(f"Event details for date {date_str}: event_date={event_date}, event={event_name}")
...
# print(df.head())  # Debugging statement to print the DataFrame
