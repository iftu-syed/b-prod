...
# # #this the new code for the promis-10 form update
# # import pymongo
# # from datetime import datetime
# # import plotly.graph_objs as go
# # from collections import defaultdict
...
# #this code is for the generating and saving the graphs to the new_folder
...
#this is the code that handle the baseline and labelling(severe,moderate, mild) on the graphs
...
#     opacity = 0.5  # Adjust this value to set the desired opacity
#     label_x = len(months_since_initial) + 1.5  # Positioning beyond the max x value
...
#         autosize=True,
#         title=dict(font=dict(size=16, color='#333'), x=0.5),
#         margin=dict(l=40, r=80, b=40, t=60),  # Increase right margin for label space
#         hoverlabel=dict(font=dict(size=12), bgcolor='rgba(255,255,255,0.8)', bordercolor='rgba(0,0,0,0.5)'),
#         legend_title=dict(font=dict(size=12, color='#333')),
#     )
