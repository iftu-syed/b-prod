...
#this is the arabic version included
...
#     ARABIC_MONTH_LABELS = [
#         "الأساسي", "شهر 1", "شهر 2", "شهر 3", "شهر 4", "شهر 5", "شهر 6", "شهر 7", "شهر 8", "شهر 9", "شهر 10", "شهر 11", "شهر 12"
#     ]
...
#                 "y0": i * max_score / gradient_steps,
#                 "y1": (i + 1) * max_score / gradient_steps,
#                 "fillcolor": f"rgba(255, 0, 0, {0.1 * (1 - i / gradient_steps)})",
#                 "layer": "below",
#                 "line": {"width": 0}
#             })
#             shapes.append({
...
#                 "y0": safe_limit + i * (max_score - safe_limit) / gradient_steps,
#                 "y1": safe_limit + (i + 1) * (max_score - safe_limit) / gradient_steps,
#                 "fillcolor": f"rgba(0, 255, 0, {0.1 * (i / gradient_steps)})",
#                 "layer": "below",
#                 "line": {"width": 0}
#             })
#     else:
...
#                 "y0": i * safe_limit / gradient_steps,
#                 "y1": (i + 1) * safe_limit / gradient_steps,
#                 "fillcolor": f"rgba(0, 255, 0, {0.1 * (1 - i / gradient_steps)})",
#                 "layer": "below",
#                 "line": {"width": 0}
#             })
#             shapes.append({
...
#                 "y0": safe_limit + i * (max_score - safe_limit) / gradient_steps,
#                 "y1": safe_limit + (i + 1) * (max_score - safe_limit) / gradient_steps,
#                 "fillcolor": f"rgba(255, 0, 0, {0.1 * (i / gradient_steps)})",
#                 "layer": "below",
#                 "line": {"width": 0}
#             })
...
#                 yref="y",
#                 x=label_x,
#                 y=safe_limit + (max_score - safe_limit) * 0.75,
...
# # Add this definition for ARABIC_MONTH_LABELS at the beginning of the generate_graph function
# ARABIC_MONTH_LABELS = [
#     "الأساسي", "شهر 1", "شهر 2", "شهر 3", "شهر 4", "شهر 5", "شهر 6", "شهر 7", "شهر 8", "شهر 9", "شهر 10", "شهر 11", "شهر 12"
# ]
# def graph_generate(mr_no, survey_type):
